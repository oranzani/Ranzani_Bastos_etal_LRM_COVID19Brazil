...
### October 2020                                                                                         ##
###                                                                                                      ##
### Figure 3. In-hospital mortality stratified by age, sex, comorbidities, level of education,           ##
...
#################################### #################################### #################################
#### Main analysis - In-hospital Mortality - IHM                                                       ####
...
plot_ihm_sex_age <-
    ...
    scale_y_continuous(labels = scales::percent_format(),
                       limits = c(0, 1)) +
    scale_fill_manual(values = c(v_color_regions_alpha_50[1], 
                                 v_color_regions_alpha[1]), name = "") +
...
#################################### #################################### #################################
#### SENSITIVITY ANALYSIS - In-hospital Mortality - IHM                                                ####
#### CLASSI_FIN == 5                                                                                   ####
#### Hospitalizations with a defined outcome (discharge or death)                                      ####
#################################### #################################### #################################
...
ggsave("Outputs/Figures/Sensitivity Analysis/sensitivity_HM_Gender_Comorb_ICU_RespSupport_Education_SkinColor.png",
       combined_plot_ihm_age,
       units = "in", dpi = 800, height = 13, width = 11)
