...
### October 2020                                                                                         ##
###                                                                                                      ##
### Figure 4. Temporal evolution of COVID-19 hospitalisation rates per 100,000 adult population          ##
...
B <- week_cases_outcome %>% 
  ...
  theme(legend.position = "none",
        axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1)) +
  labs(x = "Epidemiological weeks", y = "Hospitalisations (per 100.000)") +
...
ggsave("Outputs/Figures/Figure4_Cases_IHM_overtime.pdf",
       combined_plot_figure2,
