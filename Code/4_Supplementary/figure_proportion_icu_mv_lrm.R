...
### October 2020                                                                                         ##
### Proportion of intensive care unit admission and use of invasive mechanical ventilation               ##
###   stratified by age in hospitalised COVID-19 patients in the five regions of Brazil.                 ##    
#################################### #################################### #################################
#################################### #################################### #################################
#################################### #################################### #################################
...
#################################### #################################### #################################
#### Main analysis - Proportion of ICU admissions and Invasive Mechanical Ventilation                  ####
...
ggsave("Outputs/Figures/ICU_MV_Proportion.png",
       combined_plot_region_prop,
...
#################################### #################################### #################################
#### SENSITIVITY ANALYSIS - Proportion of ICU admissions and Invasive Mechanical Ventilation           ####
#### Hospitalizations with a defined outcome (discharge or death)                                      ####
#### CLASSI_FIN == 5                                                                                   ####
#################################### #################################### #################################
...
ggsave("Outputs/Figures/Sensitivity Analysis/sensitivity_ICU_MV_Proportion.png",
       combined_plot_region_prop,
       units = "in", dpi = 800, height = 9, width = 13)
