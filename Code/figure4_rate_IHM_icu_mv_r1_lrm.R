...
### October 2020                                                                                         ##
###                                                                                                      ##
### Figure 3. Health system burden and in-hospital mortality stratified by age in hospitalized           ##
...
# Figure 3 - Main Analysis - Rates per 100k population and IHM per --------
...
plot_reg_idade_total_100k <- 
    ...
    labs(x = "", title = "Hospitalizations", y = "per 100,000 population") +
    theme_bw()
...
## Calculates In-hospital mortality (deaths/hospitalizations) - Regions
# Overall - Regions
df_ihm_reg <-
    srag_adults_pcr_outcome %>%
...
## Calculates In-hospital mortality (deaths/hospitalizations) - Brazil
# Overall - Brazil
df_ihm_brazil <- 
    srag_adults_pcr_outcome %>%
...
ggsave("Outputs/Figures/Figure4_IHM_Rates_100k.pdf",
       combined_plot_region,
...
#### Sensitivity analysis - Hospitalizations classified as COVID-19
...
ggsave("Outputs/Figures/sensitivity_figure_IHM_Rate.png",
       combined_plot_region,
       units = "in", dpi = 800, height = 6, width = 13)
